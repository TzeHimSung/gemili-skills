...
**在跑 stage2 之前，检查 `references/hermes-bug-fixes.md`**——记录了 4 个已知 bug 及修复方法：
1. `special_cards.py` f-string 转义（Python 3.12+）
2. `institutional.py` 缺少 svg_sparkline/svg_radar import
3. Stage2 自检 blocking（美股缺 A 股专用维度）
4. DCF 返 ¥0（美股币种 mismatch）
